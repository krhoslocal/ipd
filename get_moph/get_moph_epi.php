...
$query_smsg = "SELECT concat(a.regdate,'-',paa.hn,'-',a.frequency) AS seq,
	 ...
	 left join pt.pt paa ON paa.hn=a.hn
		WHERE a.regdate='$silind_regdate' AND a.hn='$ssidilind_hn'";
...
$query_smsg = "SELECT concat(a.regdate,'-',paa.hn,'-',a.frequency) AS seq,
		...
		(SELECT labcode FROM claim_moph.target_lab bb WHERE bb.regdate=a.regdate AND bb.hn=a.hn AND bb.type_group='HT' AND labcode='32001') AS labcode_po,
		(SELECT namelab FROM claim_moph.target_lab bb WHERE bb.regdate=a.regdate AND bb.hn=a.hn AND bb.type_group='HT' AND labcode='32001') AS namelab_po,
		(SELECT result_lab FROM claim_moph.target_lab bb WHERE bb.regdate=a.regdate AND bb.hn=a.hn AND bb.type_group='HT' AND labcode='32001') AS result_lab_po,
		(SELECT labcode FROM claim_moph.target_lab bb WHERE bb.regdate=a.regdate AND bb.hn=a.hn AND bb.type_group='HT' AND labcode='32202') AS labcode_cr,
		(SELECT namelab FROM claim_moph.target_lab bb WHERE bb.regdate=a.regdate AND bb.hn=a.hn AND bb.type_group='HT' AND labcode='32202') AS namelab_cr,
		(SELECT result_lab FROM claim_moph.target_lab bb WHERE bb.regdate=a.regdate AND bb.hn=a.hn AND bb.type_group='HT' AND labcode='32202') AS result_lab_cr
	 FROM claim_moph.target a
	 left join pt.pt paa ON paa.hn=a.hn
